...
cor1 = "#403b36" # black/preta
cor2 = "#dbdaed" # white/branca
cor3 = "#355ce8" # azul carregando
cor4 = "#626778" # cizenta
cor5 = "#f79431" # orange/laranja
...
b_1 = Button(frame_corpo, command=limar_tela, text= "C", width=11, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=0)
